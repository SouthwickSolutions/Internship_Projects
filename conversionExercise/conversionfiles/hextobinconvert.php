...
<html>
    <body>
            ...
            <?php
                if($answer == $studentanswer){
                    ...
                    echo "<style>
                          ...
                          <form action=\"../starterfiles/hextobin.php\">
        ...
        <p class="form1">Convert #<?php echo $generatednumber;?> to binary (no spaces):</p>
        <div class="form1">
            <form action="hextobinconvert.php" method="post">
                <input type='hidden' name='generatednumber' value='<?php echo "$generatednumber";?>'/> 
                <input type="text" name="studentanswer">
                <input type="submit">
                <input type="button" onclick="window.location='../starterfiles/hextobin.php'" value="Try Another"/>
