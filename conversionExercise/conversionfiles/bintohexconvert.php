...
<html>
    <body>
            ...
            <?php
                if($answer == $studentanswer){
                    ...
                    echo "<style>
                          ...
                          <form action=\"../starterfiles/bintohex.php\">
        ...
        <div class="form1">
            <form action="bintohexconvert.php" method="post">
                <input type='hidden' name='generatednumber' value='<?php echo "$generatednumber";?>'/> 
                <input type="text" name="studentanswer">
                <input type="submit">
                <input type="button" onclick="window.location='../starterfiles/bintohex.php'" value="Try Another"/>
