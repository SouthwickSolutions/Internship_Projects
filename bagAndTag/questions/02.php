...
<html>
    ...
    <body>
        <div class="container">
            ...
            <article>
                <center id="afterquestion">
                    <img src="../images/barbasol01.jpg" width=155 height=377 border=2>
                </center>
                ...
                <form  id="form1" action=" ">
                    ...
                    <input type="radio" name="answer" value="0" />Take the Barbasol<br/>
                    <input type="radio" name="answer" value="1" />Leave the Barbasol<br/>
        ...
        <center>
            <a href="01.php" class="previous">&laquo; Previous</a>
            |
            <a href="02.php" class="reload">Reload</a>
            |
            <a href="03.php" class="next">Next &raquo;</a>
        </center>
        ...
        <script>
            ...
            document.getElementById("form1").onsubmit=function() {
                ...
                remove_image();
                show_image('../images/barbasol02.jpg', 292, 406, 2);

                if (answer == 0) {
                    response = "This is partly correct. If you take this I hope you plan on further evaluating it because this container has a hidden compartment that reveals to hold a cell phone."
                };
                ...
                if (answer == 2) {
                    response = "Correct! Upon further evaluation, you will find that this Barbasol container has a hidden compartment."
                };
