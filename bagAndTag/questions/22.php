...
<html>
    ...
    <body>
        <div class="container">
            ...
            <article>
                <center id="afterquestion">
                    <img src="../images/simcard01.jpg" width=224 height=146 border=2>
                    <img src="../images/simcard02.jpg" width=218 height=133 border=2>
                </center>
                ...
                <form  id="form1" action=" ">
                    ...
                    <input type="radio" name="answer" value="0" />Take the SIM Card<br/>
                    <input type="radio" name="answer" value="1" />Leave the SIM Card<br/>
        ...
        <center>
            <a href="21.php" class="previous">&laquo; Previous</a>
            |
            <a href="22.php" class="reload">Reload</a>
            |
            <a href="23.php" class="next">Next &raquo;</a>
        </center>
        ...
        <script>
            ...
            document.getElementById("form1").onsubmit=function() {
                ...
                if (answer == 0) {
                    response = "This is incorrect. A SIM card has no value when it comes to evidence. You can leave this."
                };

                if (answer == 1) {
                    response = "Correct! A SIM card has no value when it comes to evidence. You can leave this."
                };
