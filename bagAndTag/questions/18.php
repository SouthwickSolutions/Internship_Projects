...
<html>
    ...
    <body>
        <div class="container">
            ...
            <article>
                <center id="afterquestion">
                    <img src="../images/ram01.jpg" width=565 height=147 border=2>
                ...
                <form  id="form1" action=" ">
                    ...
                    <input type="radio" name="answer" value="0" />Take the Stick of RAM<br/>
                    <input type="radio" name="answer" value="1" />Leave the Stick of RAM<br/>
        ...
        <center>
            <a href="17.php" class="previous">&laquo; Previous</a>
            |
            <a href="18.php" class="reload">Reload</a>
            |
            <a href="19.php" class="next">Next &raquo;</a>
        </center>
        ...
        <script>
            ...
            document.getElementById("form1").onsubmit=function() {
                ...
                if (answer == 0) {
                    response = "This is incorrect. RAM has volitile memory meaning if it has no power then there is no internal memory. Leave it."
                };

                if (answer == 1) {
                    response = "Correct! RAM has volitile memory meaning if it has no power then there is no internal memory."
                };
