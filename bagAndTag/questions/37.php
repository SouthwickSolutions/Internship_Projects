...
<html>
    ...
    <body>
        <div class="container">
            ...
            <article>
                <center id="afterquestion">
                    <img src="../images/water01.jpg" width=105 height=377 border=2>
                </center>
                ...
                <form  id="form1" action=" ">
                    ...
                    <input type="radio" name="answer" value="0" />Take the Water Bottle<br/>
                    <input type="radio" name="answer" value="1" />Leave the Water Bottle<br/>
        ...
        <center>
            <a href="36.php" class="previous">&laquo; Previous</a>
            |
            <a href="37.php" class="reload">Reload</a>
            |
            <a href="38.php" class="next">Next &raquo;</a>
        </center>
        ...
        <script>
            ...
            document.getElementById("form1").onsubmit=function() {
                ...
                remove_image();
                show_image('../images/water02.jpg', 324, 332, 2);
                ...
                if (answer == 2) {
                    response = "Correct! Upon further evaluation, you will find that this water bottle has a hidden compartment. Take it with you."
                };
