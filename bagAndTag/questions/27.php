...
<html>
    ...
    <body>
        <div class="container">
            ...
            <article>
                <center id="afterquestion">
                    <img src="../images/musicplayer01.jpg" width=263 height=384 border=2>
                </center>
                ...
                <form  id="form1" action=" ">
                    ...
                    <input type="radio" name="answer" value="0" />Take the MP3 Player<br/>
                    <input type="radio" name="answer" value="1" />Leave the MP3 Player<br/>
        ...
        <center>
            <a href="26.php" class="previous">&laquo; Previous</a>
            |
            <a href="27.php" class="reload">Reload</a>
            |
            <a href="28.php" class="next">Next &raquo;</a>
        </center>
        ...
        <script>
            ...
            document.getElementById("form1").onsubmit=function() {
                ...
                if (answer == 0) {
                    response = "Correct! An MP3 player has internal memory and may include files other than MP3 files."
                };

                if (answer == 1) {
                    response = "This is incorrect. An MP3 player has internal memory and may include files other than MP3 files. Take this with you."
                };
